//This code is derived from electronoobs website and youtube channel.
//main reason to use this code because of its ability to simulate pwm signals needed for the flight controller with esp32
// main credit = electronoobs
#include <SPI.h>
#include <nRF24L01.h>
#include <RF24.h>
